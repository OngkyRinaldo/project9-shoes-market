...
const contact = () => {
    return (
        <div className='w-full pt-12 h-fit pb-5 bg-[#E5E5E5]'>
            <div className='container mx-auto font-urbanist'>
                ...
                <div className='px-5 text-center mt-10  '>
                    ...
                    <p className='text-base  px-5 md:px-0'>
                        Answers to our most frequently asked questions are just
                        one click away
                    </p>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-2 mt-10'>
                        ...
                        <div className=' cursor-pointer'>
                            ...
                            <p className='text-center '>Where is my refund?</p>
                        </div>
                ...
                <div className='px-5 text-center mt-10'>
                    ...
                    <hr className='text-white hidden md:block md:mt-5' />
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-2 mt-10'>
                        <div className='cursor-pointer border border-black rounded-lg bg-white py-5 px-8 '>
